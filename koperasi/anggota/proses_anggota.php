<?php
	...
	$alamat_anggota=isset($_POST['alamat_anggota']) ? $_POST['alamat_anggota'] : '' ;
	...
	$tempat_lahir=isset($_POST['tmp_lahir']) ? $_POST['tmp_lahir']: '' ;
	...
	switch ($pros){
		...
		else if($tuggak==0)
		{
			...
			$qdelete=mysqli_query($koneksi,"DELETE FROM t_anggota WHERE kode_anggota='$kode'");
			if($qdelete){ ?>
				<script>
					alert("data telah terhapus");window.location="../index.php?pilih=1.2"
				</script>
