...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2024 at 05:30 AM
...
('A0006', 48, 'Anggota 6', 'Alamat Ya Indonesia', 'Perempuan', 'Wiraswastazzzz', '2020-12-09', '087741130522', 'Jakarta', '2020-12-01', 'aktif', 'Kang Admin', '2024-03-30'),
...
(159, 60, 6, 183333, 1027000, -99998, 'A0001', '<br /><b>Notice</b>:  session_start(): Ignoring se', '2024-03-30');
...
('S0003', 'sukarela', 25000, 'Umar', '2024-04-04');
...
(3, '2020-12-09', 'A0010', 'P0001', 5000000, '2024-03-30', 'diterima'),
(4, '2020-12-09', 'A0002', 'P0002', 7000000, '2020-12-09', 'diterima'),
(5, '2020-12-09', 'A0004', 'P0001', 5000000, '2024-03-30', 'diterima'),
...
('P0001', 'operatorzsss', 'Alamat Indonesia', '080041130523', 'Perempuan', '<br /><b>Notice</b>:  session_start(): Ignoring se', '2017-02-16'),
('P0004', 'Umarinajah', 'ujung kulon', '083866926117', 'Laki-laki', '<br /><b>Notice</b>:  session_start(): Ignoring se', '2024-03-31'),
...
(60, 'A0001', 'P0003', 1000000, 183333, 12, 6, -99998, 'Kang Admin', '2020-12-09', '2021-07-07', 'belum lunas'),
(68, 'A0014', 'P0004', 30000000, 10000000, 30, 2, 10000000, '', '2020-12-09', '2021-03-09', 'belum lunas'),
(69, 'A0004', 'P0001', 5000000, 1250000, 5, 0, 5000000, '', '2024-03-30', '2024-04-29', 'belum lunas'),
(70, 'A0010', 'P0001', 5000000, 1250000, 5, 0, 5000000, '', '2024-03-30', '2024-04-29', 'belum lunas');
...
(191, 'wajib', 15000, 'A0001', '<br /><b>Notice</b>:  session_start(): Ignoring se', '1970-01-08', '2024-03-30'),
(192, 'wajib', 15000, 'A0001', '<br /><b>Notice</b>:  session_start(): Ignoring se', '1970-01-08', '2024-03-30'),
(193, 'sukarela', 100, 'A0001', '<br /><b>Notice</b>:  session_start(): Ignoring se', '2024-03-30', '2024-03-30'),
(194, 'sukarela', 10000000, 'A0001', '<br /><b>Notice</b>:  session_start(): Ignoring se', '2024-03-30', '2024-03-30'),
(195, 'sukarela', 5000000, 'A0001', '<br /><b>Notice</b>:  session_start(): Ignoring se', '2024-03-30', '2024-03-30'),
(196, 'wajib', 15000, 'A0001', '<br /><b>Notice</b>:  session_start(): Ignoring se', '1970-01-08', '2024-03-30'),
(197, 'wajib', 15000, 'A0014', '<br /><b>Notice</b>:  session_start(): Ignoring se', '1970-01-08', '2024-03-30'),
(198, 'sukarela', 0, 'A0014', '<br /><b>Notice</b>:  session_start(): Ignoring se', '2024-03-30', '2024-03-30');
...
(56, 'A0014', '2020-12-09', 14000),
(54, 'A0012', '2020-12-09', 10000),
(12, 'A0001', '2020-12-01', 15090100);
...
('U0004', '', 'umarinajah', 'umarin', 'Umar', '2024-04-04', 'tidak ada', 'admin');
...
--
ALTER TABLE `t_angsur`
  MODIFY `kode_angsur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=160;
...
--
ALTER TABLE `t_pengambilan`
  MODIFY `kode_ambil` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `t_pinjam`
--
ALTER TABLE `t_pinjam`
  MODIFY `kode_pinjam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table `t_simpan`
--
ALTER TABLE `t_simpan`
  MODIFY `kode_simpan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200;
