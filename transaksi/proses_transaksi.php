...
// SIMPAN
$kode_simpan		= isset($_POST['kode_simpan']) ? $_POST['kode_simpan'] : '';
$tgl_simpan			= isset($_POST['tgl_simpan']) ? $_POST['tgl_simpan'] : '' ;
...
{
	$ambil=mysqli_query($koneksi, "SELECT * FROM t_simpan where kode_anggota='$kode_anggota' and jenis_simpan='wajib' order by kode_simpan desc ");
