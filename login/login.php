...
<head>    
    <link rel="shortcut icon" href="../Logo TEKKOM New 2023-01.png"> 
        ...
        <div class="row">
          <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
            ...
            <div class="login-logo">
                  <a href="#"><img class="img-responsive" src="../Logo TEKKOM New 2023-01.png" width="150" height="150" alt="Company Logo" /></a>
                </div> 
                <hr />
